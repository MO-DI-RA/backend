...
urlpatterns=[
    ...
    path('posts/<int:pk>/comments/<int:comment_pk>/reply/', AnswerCommentListAPIView.as_view()),
    path('posts/<int:pk>/comments/<int:comment_pk>/reply/<int:reply_pk>', AnswerCommentAPIView.as_view()), 
]
